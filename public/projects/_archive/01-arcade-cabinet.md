...
throughout the process, I tweaked and tested and benchmarked various embeddings models with evals:

<img src="/media/icons-mcp/evals1.png" alt="evals" />

<img src="/media/cabinet/evals-3.png" alt="evals" />

and added a debug mode for extra testing:

<img src="/media/cabinet/debug.png" alt="debug" />

also explored wild options:
